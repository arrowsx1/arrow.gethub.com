...
cc._supportRender=!0):cc._supportRender=!1}function b(a,c,d){if(h[c])return null;d=d||"";var e=[],f=a[c];if(!f)throw Error("can not find module ["+c+"]");c=cc.path;for(var g=0,k=f.length;g<k;g++){var m=f[g];if(!h[m]){var y=c.extname(m);y?".js"===y.toLowerCase()&&e.push(c.join(d,m)):(y=b(a,m,d))&&(e=e.concat(y));h[m]=1}}return e}function c(a){cc._initDebugSetting&&cc._initDebugSetting(a[cc.game.CONFIG_KEY.debugMode]);cc._engineLoaded=!0;cc.log(cc.ENGINE_VERSION);m&&m()}function d(a){var d=a[cc.game.CONFIG_KEY.engineDir],
e=cc.loader;if(cc.Class)c(a);else{var f=cc.path.join(d,"moduleConfig.json");e.loadJson(f,function(e,f){if(e)throw Error(e);var g=a.modules||[],h=f.module,k=[];cc.sys.capabilities.opengl&&0>g.indexOf("base4webgl")?g.splice(0,0,"base4webgl"):0>g.indexOf("core")&&g.splice(0,0,"core");for(var m=0,r=g.length;m<r;m++){var s=b(h,g[m],d);s&&(k=k.concat(s))}cc.loader.loadJsWithImg(k,function(b){if(b)throw b;c(a)})})}}function e(){this.removeEventListener("load",e,!1);d(cc.game.config)}var f=document.createElement("canvas"),
...
k=!1,y="",z=0,x=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);x&&(k=!0,y=x[1]||"",z=parseInt(y)||0);if(x=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))m=!0,y=x[2]||"",z=parseInt(y)||0;x=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?x=a.OS_WINDOWS:m?x=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?x=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?x=a.OS_UNIX:k?x=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&(x=a.OS_LINUX);a.os=x;a.osVersion=
y;a.osMainVersion=z;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:"360 aphone"===b?b=a.BROWSER_TYPE_360:
...
cc.sys.isMobile&&(k=document.createElement("style"),k.type="text/css",document.body.appendChild(k),k.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var w=a.localStorage=b.localStorage;w.setItem("storage","");w.removeItem("storage");w=null}catch(B){w=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},a.localStorage=
{getItem:w,setItem:w,removeItem:w,clear:w}}w=!!f.getContext("2d");k=!1;m=document.createElement("CANVAS");if(b.WebGLRenderingContext)try{cc.create3DContext(m,{stencil:!0,preserveDrawingBuffer:!0})&&(k=!0)}catch(C){}w=a.capabilities={canvas:w,opengl:k};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)w.touches=!0;void 0!==e.onmouseup&&(w.mouse=!0);void 0!==e.onkeyup&&(w.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)w.accelerometer=!0;a.garbageCollect=function(){};
...
k;a[6]=c;a[7]=g;return this};b.determinant=function(){var a=this.mat,b=a[0]*a[4]*a[8]+a[1]*a[5]*a[6]+a[2]*a[3]*a[7];return b-=a[2]*a[4]*a[6]+a[0]*a[5]*a[7]+a[1]*a[3]*a[8]};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var g=b[1],h=b[2],k=b[3],m=b[4],n=b[5],p=b[6],s=b[7],r=b[8],t=c[0],u=c[1],v=c[2],A=c[3],y=c[4],z=c[5],x=c[6],w=c[7],c=c[8];b[0]=a*t+k*u+p*v;b[1]=g*t+m*u+s*v;b[2]=h*t+n*u+r*v;b[3]=h*t+n*u+r*v;b[4]=g*A+m*y+s*z;b[5]=h*A+n*y+r*z;b[6]=a*x+k*w+p*c;b[7]=g*x+m*w+s*c;b[8]=h*x+n*w+r*c;
...
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=t;a[8]=c;a[9]=k;a[11]=u;a[12]=d;a[13]=m;a[14]=s;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],s=k[4],r=k[5],t=k[6],u=k[7],v=k[8],A=k[9],y=k[10],z=k[11],x=k[12],w=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*s+E*v+F*x;d[1]=C*b+D*r+E*A+F*w;d[2]=C*n+D*t+E*y+F*B;d[3]=C*p+D*u+E*z+F*k;d[4]=G*c+H*s+I*v+J*x;d[5]=
G*b+H*r+I*A+J*w;d[6]=G*n+H*t+I*y+J*B;d[7]=G*p+H*u+I*z+J*k;d[8]=K*c+L*s+M*v+N*x;d[9]=K*b+L*r+M*A+N*w;d[10]=K*n+L*t+M*y+N*B;d[11]=K*p+L*u+M*z+N*k;d[12]=O*c+P*s+Q*v+m*x;d[13]=O*b+P*r+Q*A+m*w;d[14]=O*n+P*t+Q*y+m*B;d[15]=O*p+P*u+Q*z+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],s=b[6],r=b[7],t=b[8],u=b[9],v=b[10],A=b[11],y=b[12],z=b[13],x=b[14],w=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*t+E*y;b[1]=B*d+C*p+D*u+E*z;b[2]=B*k+C*s+D*v+E*x;b[3]=B*m+C*r+D*A+E*w;b[4]=F*a+G*n+H*t+I*y;b[5]=F*d+G*p+H*u+I*z;b[6]=F*k+G*s+H*v+I*x;b[7]=F*m+G*r+H*A+I*w;b[8]=J*a+K*n+L*t+M*y;b[9]=J*d+K*p+L*u+M*z;b[10]=J*k+K*s+L*v+M*x;b[11]=J*m+K*r+L*A+M*w;b[12]=N*a+O*n+P*t+c*y;b[13]=N*d+O*p+P*u+c*z;b[14]=N*k+O*s+P*v+c*x;b[15]=N*m+O*r+P*A+c*w;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
cc.glBindVAO=function(a){cc.TEXTURE_ATLAS_USE_VAO&&cc.ENABLE_GL_STATE_CACHE&&cc._uVAO!==a&&(cc._uVAO=a)};cc.glEnable=function(a){};cc.ACTION_TAG_INVALID=-1;
...
for(var m=e.quads,n=this._displayedColor,n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,s=a._itemHeight,r=0,t=-1;r<d;r++){var u=c.charCodeAt(r)-a._mapStartChar.charCodeAt(0),v=u%a._itemsPerRow,A=0|u/a._itemsPerRow;if(!(0>v||0>A||v*p+p>g||A*s+s>f)){t++;var y;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(v=(2*v*h+1)/(2*g),u=v+(2*h-2)/(2*g),A=(2*A*k+1)/(2*f),y=A+(2*k-2)/(2*f)):(v=v*h/g,u=v+h/g,A=A*k/f,y=A+k/f);var z=m[r],x=z.tl,w=z.tr,B=z.bl,z=z.br;x.texCoords.u=v;x.texCoords.v=A;w.texCoords.u=u;
w.texCoords.v=A;B.texCoords.u=v;B.texCoords.v=y;z.texCoords.u=u;z.texCoords.v=y;B.vertices.x=t*p;B.vertices.y=0;B.vertices.z=0;z.vertices.x=t*p+p;z.vertices.y=0;z.vertices.z=0;x.vertices.x=t*p;x.vertices.y=a._itemHeight;x.vertices.z=0;w.vertices.x=t*p+p;w.vertices.y=a._itemHeight;w.vertices.z=0;x.colors=n;w.colors=n;B.colors=n;z.colors=n}}this.updateContentSize(r,t+1);0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.updateContentSize=function(a,c){var d=this._node,e=d._contentSize;
...
this._currentStencilEnabled||a.disable(a.STENCIL_TEST);cc.ClippingNode.WebGLRenderCmd._layer--}})();var res={},g_resources=[],i;for(i in res)g_resources.push(res[i]);function trace(){cc.log(Array.prototype.join.call(arguments,", "))}
var GameLayer=cc.Layer.extend({mapPanel:null,ui:null,score:0,level:0,steps:0,limitStep:0,myTargetScore:0,map:null,moving:!1,ctor:function(){this._super();var a=cc.winSize,b=new cc.Sprite("res/bg.jpg");this.addChild(b);b.x=a.width/2;b.y=a.height/2;b=new cc.ClippingNode;this.addChild(b,2);this.mapPanel=new cc.Layer;this.mapPanel.x=(a.width-Constant.CANDY_WIDTH*Constant.MAP_SIZE)/2;this.mapPanel.y=(a.height-Constant.CANDY_WIDTH*Constant.MAP_SIZE)/2;b.addChild(this.mapPanel,1);a=new cc.DrawNode;a.drawRect(cc.p(this.mapPanel.x,
this.mapPanel.y),cc.p(this.mapPanel.x+Constant.CANDY_WIDTH*Constant.MAP_SIZE,this.mapPanel.y+Constant.CANDY_WIDTH*Constant.MAP_SIZE),cc.color(0,0,0),1,cc.color(0,0,0));b.stencil=a;"touches"in cc.sys.capabilities?cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegin:this._onTouchBegin.bind(this)},this.mapPanel):cc.eventManager.addListener({event:cc.EventListener.MOUSE,onMouseDown:this._onMouseDown.bind(this)},this.mapPanel);this._init();this.ui=new GameUI(this);this.addChild(this.ui,
3);return!0},_init:function(){5<=Storage.getCurrentLevel()&&(Storage.setCurrentLevel(0),Storage.setCurrentScore(0));this.steps=0;this.level=Storage.getCurrentLevel();this.score=Storage.getCurrentScore();this.limitStep=Constant.levels[this.level].limitStep;this.myTargetScore=Constant.levels[this.level].tagertScore;this.map=[];for(var a=0;a<Constant.MAP_SIZE;a++){for(var b=[],c=0;c<Constant.MAP_SIZE;c++){var d=Candy.createRandomType(a,c);this.mapPanel.addChild(d);d.x=a*Constant.CANDY_WIDTH+Constant.CANDY_WIDTH/
2;d.y=c*Constant.CANDY_WIDTH+Constant.CANDY_WIDTH/2;b.push(d)}this.map.push(b)}},_onTouchBegin:function(a,b){var c=Math.floor((a.getLocation().x-this.mapPanel.x)/Constant.CANDY_WIDTH),d=Math.floor((a.getLocation().y-this.mapPanel.y)/Constant.CANDY_WIDTH);this._popCandy(c,d);return!0},_onMouseDown:function(a){var b=Math.floor((a.getLocation().x-this.mapPanel.x)/Constant.CANDY_WIDTH);a=Math.floor((a.getLocation().y-this.mapPanel.y)/Constant.CANDY_WIDTH);this._popCandy(b,a)},_popCandy:function(a,b){if(!this.moving){for(var c=
...
a)},_checkSucceedOrFail:function(){this.score>this.myTargetScore?(this.ui.showSuccess(),this.score+=30*(this.limitStep-this.steps),Storage.setCurrentLevel(this.level+1),Storage.setCurrentScore(this.score),this.scheduleOnce(function(){cc.director.runScene(new GameScene)},3)):this.steps>=this.limitStep&&(this.ui.showFail(),Storage.setCurrentLevel(0),Storage.setCurrentScore(0),this.scheduleOnce(function(){cc.director.runScene(new GameScene)},3))},_finishCandyFalls:function(){this.moving=!1}}),GameScene=
cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}});var Candy=cc.Sprite.extend({type:0,column:0,row:0,ctor:function(a,b,c){this._super("res/"+(a+1)+".png");this.init(a,b,c)},init:function(a,b,c){this.type=a;this.column=b;this.row=c}});Candy.createRandomType=function(a,b){return new Candy(parseInt(Math.random()*Constant.CANDY_TYPE_COUNT),a,b)};var Constant={CANDY_TYPE_COUNT:5,CANDY_WIDTH:64,MAP_SIZE:10,FALL_ACCELERATION:30,levels:[{limitStep:30,tagertScore:700},{limitStep:25,tagertScore:1500},{limitStep:20,tagertScore:2300},{limitStep:20,tagertScore:3300},{limitStep:15,tagertScore:4400},{limitStep:10,tagertScore:5600}]};var GameUI=cc.Layer.extend({levelText:null,scoreText:null,stepText:null,gameLayer:null,ctor:function(a){this._super();this.gameLayer=a;this._initInfoPanel();this.scheduleUpdate();return!0},_initInfoPanel:function(){var a=cc.director.getWinSize(),b=new cc.LabelTTF("Level","arial",36);b.x=100;b.y=a.height-50;b.setColor(cc.color(0,0,0));this.addChild(b);a=new cc.LabelTTF("1","arial",36);a.x=100;a.y=b.y-40;a.setColor(cc.color(0,0,0));this.addChild(a);this.levelText=a;var c=new cc.LabelTTF("Score","arial",
36);c.x=370;c.y=b.y;c.setColor(cc.color(0,0,0));this.addChild(c);c=new cc.LabelTTF("1","arial",36);c.x=370;c.y=a.y;c.setColor(cc.color(0,0,0));this.addChild(c);this.scoreText=c;c=new cc.LabelTTF("Step","arial",36);c.x=620;c.y=b.y;c.setColor(cc.color(0,0,0));this.addChild(c);b=new cc.LabelTTF("1","arial",36);b.x=620;b.y=a.y;b.setColor(cc.color(0,0,0));this.addChild(b);this.stepText=b},update:function(){this.levelText.setString(""+(this.gameLayer.level+1));this.scoreText.setString(""+this.gameLayer.score);
this.stepText.setString(""+(this.gameLayer.limitStep-this.gameLayer.steps))},showSuccess:function(){var a=new cc.LayerColor(cc.color(255,255,255),500,500);this.addChild(a,1);var b=cc.director.getWinSize();a.x=(b.width-a.width)/2;a.y=(b.height-a.height)/2;b=new cc.LabelTTF("\u606d\u559c\uff0c\u5df2\u5b8c\u6210\u7b2c"+(this.gameLayer.level+1)+"\u5173,\n\u5269\u4f59\u6b65\u657030\u500d\u5956\u52b1\uff01","arial",50);b.setColor(cc.color(0,0,0));b.x=250;b.y=250;a.addChild(b)},showFail:function(){var a=
new cc.LayerColor(cc.color(255,255,255),500,500);this.addChild(a,1);var b=cc.director.getWinSize();a.x=(b.width-a.width)/2;a.y=(b.height-a.height)/2;b=new cc.LabelTTF("\u5931\u8d25\u4e86\uff0c\n\u91cd\u5934\u6765\u8fc7\u5427\uff01","arial",56);b.setColor(cc.color(0,0,0));b.x=250;b.y=250;a.addChild(b)}});var Storage={getCurrentLevel:function(){var a=cc.sys.localStorage.getItem("level")||0;return parseInt(a)},setCurrentLevel:function(a){cc.sys.localStorage.setItem("level",a);return!0},getCurrentScore:function(){var a=cc.sys.localStorage.getItem("score")||0;return parseInt(a)},setCurrentScore:function(a){cc.sys.localStorage.setItem("score",a);return!0}};cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(720,1280,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new GameScene)},this)};cc.game.run();